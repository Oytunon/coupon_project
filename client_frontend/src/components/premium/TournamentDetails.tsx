                            ...
                            <div className="space-y-4">
                                ...
                                <div className="space-y-4">
                                    {event.content_rules_html?.trim() ? (
                                        <div
                                            className="content-rules-html w-full min-w-0 max-w-none rounded-xl border border-[#D9B648]/20 bg-black/40 p-4 md:p-6 text-left text-gray-200 text-sm md:text-base leading-relaxed break-words [overflow-wrap:anywhere] [&_a]:text-[#D9B648] [&_a]:underline [&_ul]:my-2 [&_ul]:list-disc [&_ul]:pl-5 [&_ul]:space-y-1 [&_ol]:my-2 [&_ol]:list-decimal [&_ol]:pl-5 [&_h1]:mt-4 [&_h1]:text-xl [&_h1]:font-bold [&_h1]:text-[#F7EBA5] [&_h2]:mt-3 [&_h2]:text-lg [&_h2]:font-bold [&_h2]:text-[#F7EBA5] [&_h3]:mt-2 [&_h3]:font-semibold [&_p]:mb-3 [&_p]:last:mb-0 [&_strong]:text-[#F7EBA5] [&_img]:max-w-full [&_img]:h-auto [&_table]:w-full [&_table]:text-sm [&_table]:border-collapse [&_td]:border [&_td]:border-[#D9B648]/30 [&_td]:p-2 [&_th]:border [&_th]:border-[#D9B648]/30 [&_th]:p-2 [&_pre]:max-w-full [&_pre]:overflow-x-auto [&_pre]:whitespace-pre-wrap"
