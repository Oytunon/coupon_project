...
export function TournamentCard({
    ...
    return (
        <Card
            ...
            className="group overflow-hidden bg-black border-primary border-[3px] rounded-[24px] mb-6 cursor-pointer relative shadow-[0_0_30px_rgba(255,184,0,0.05)] transition-all duration-500 hover:shadow-[0_20px_80px_rgba(255,184,0,0.2)] hover:border-primary hover:scale-[1.01] hover:-translate-y-1 active:scale-[0.99] z-10"
        >
