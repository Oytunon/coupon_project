                ...
                <div className="flex-shrink-0 w-32 border-r-2 border-[#D9B648] overflow-hidden">
                    {image_url ? (
                        ...
                        <div className="w-full h-full bg-zinc-900 flex items-center justify-center">
                            <span className="text-[#D9B648] text-xs">No Img</span>
                        </div>
                    )}
                </div>
                    ...
                    <div className="flex items-stretch gap-1.5">
                        ...
                        <div className="flex-1 bg-[#1a1a1a] border-2 border-[#D9B648] rounded-lg px-2 py-1.5 flex flex-col items-center justify-center">
                            <div className="flex items-center justify-center gap-1 mb-0.5">
                                <svg className="w-3.5 h-3.5 text-[#D9B648]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <div className="flex-1 bg-gradient-to-br from-[#D9B648]/20 to-black border-2 border-[#D9B648] rounded-lg px-2 py-1.5 flex flex-col items-center justify-center">
                            <div className="flex items-center justify-center gap-1 mb-0.5">
                                <svg className="w-3.5 h-3.5 text-[#D9B648]" fill="currentColor" viewBox="0 0 24 24">
                                ...
                                return (
                                    <div key={label} className="contents">
                                        <div className="text-center">
                                                    ...
                                                    {digits.map((d, i) => (
                                                        <div key={i} className="relative w-[18px] h-[28px] overflow-hidden">
                                                            <div className="absolute inset-0 flex items-center justify-center bg-black rounded transition-transform duration-150 ease-out" style={{ transform: 'translateY(0px)', opacity: 1 }}>
                                                                <span className="text-xl font-bold text-[#D9B648] tabular-nums font-oswald">{d}</span>
                                                            </div>
                                            ...
                                            <div className="text-[9px] text-[#F7EBA5] mt-1 font-bold uppercase tracking-wide">{label}</div>
                                        </div>
                                        {idx < 2 && <div className="font-oswald text-2xl font-bold text-[#D9B648]/70 pb-5 animate-pulse">:</div>}
                                    </div>
                                )
                            })}
                        </div>
