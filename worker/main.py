...
# Not: "stake_floor_thousand" (Kickoff) gibi branşa özel formüller ayrı bir worker
# geçişi GEREKTİRMİYOR — event aktif olduğu sürece process_coupons() zaten tüm
# aktif event'leri tek taramada işliyor, sport/bet-type eligibility kontrolü
# per-event bazda scoring_engine içinde otomatik uygulanıyor.
