...
def run_migrations_online() -> None:
    ...
    with connectable.connect() as connection:
        # SQLite için batch operations desteği
        # SQLite bazı ALTER TABLE komutlarını desteklemez
        # Batch mode bu sorunu çözer
        context.configure(
            connection=connection,
            target_metadata=target_metadata,
            render_as_batch=True,  # SQLite için kritik!
            compare_type=True,  # Kolon tiplerini karşılaştır
            compare_server_default=True,  # Server default'ları karşılaştır
        )
